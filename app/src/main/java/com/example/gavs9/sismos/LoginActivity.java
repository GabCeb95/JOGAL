...
import com.example.gavs9.sismos.Services.UsuarioService;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void registrar(View view){
        ...
        builder1.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        hm.put("nombre",texto.getText().toString());
                        hm.put("password",password.getText().toString());
                        hm.put("usuario",usuario.getText().toString());

                        us.add(hm);
                        Snackbar.make(findViewById(android.R.id.content), "Registrado Correctamente", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                    }
                });
        ...
        builder1.setNegativeButton("Cancelar",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Snackbar.make(findViewById(android.R.id.content), "Cancelado", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                    }
                });
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password) throws ExecutionException, InterruptedException {
            mEmail = email;
            mPassword = password;
            usuarios = us.get();
        }
